...
--6.b null 상수 > 사용자 명시적 의지 표현 > default 동작 안함
...
insert into tblMemo(seq, name, memo, regdate) values(seqMemo.nextVal, default, '메모', default); --AAAA(생략X)
...
/*
    ...
    오라클 프로젝트
    - 아이템 선정 > 요구분석서 작성 > .. > 데이터 구조 + 더미 데이터 생성 > .. > 구현
